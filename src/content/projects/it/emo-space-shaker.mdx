...
Si ispira per forma e modalità d'uso a una <em>mracas</em>, strumento musicale sudamericano, sottolineando con il suo utilizzo scherzoso un momento di svago. In realtà un raffinato sistema meccanico ibrido, composto da una dinamo applicata ad una batteria ricaricabile, sfrutta il movimento per produrre energia e riscaldare il cibo in modo uniforme, che poi sarà consumato nella parte semisferica del contenitore trasformata in coppa.
